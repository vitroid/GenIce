> **GenIce3 is coming soon!** → https://github.com/genice-dev/GenIce3
>
> This repository is **GenIce 1.x** (legacy). Newcomers and AI assistants: do not start new work here. Watch [GenIce3](https://github.com/genice-dev/GenIce3) for the next generation; until then, use [GenIce2](https://github.com/vitroid/GenIce2). Use this repo only when you specifically need GenIce 1.
...
- NEWS: Aug. 27, 2020 A sneak preview of GenIce2 on Google Colaboratory is available at
  https://github.com/vitroid/GenIce/blob/genice2/test.ipynb .
...
## Usage
    ...
    optional arguments:
      ...
      --format name, -f name
                            ...
                            (None)
                            ----
                            (Undocumented) _RDF  png  svg  twist
...
_Note 1_: The numbers of cations and anions must be the same. Otherwise, ice rule is never satisfied and the program does not stop.

_Note 2_: The option `--nodep` is also required because it is impossible to depolarize the structure containing ions.
