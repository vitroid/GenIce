desc = {
    "ref": {"PCOD8301974": "Engel 2018", "engel20": "Engel 2018"},
...
class UnitCell(genice3.unitcell.UnitCell):
    ...
    def __init__(self, **kwargs):
        ...
        waters = np.array(
            [
                [0.292711, 0.32763, 0.328359],
                [0.077596, 0.44771, 0.458224],
                [0.0451, 0.084941, 0.081428],
                ...
                [0.079667, 0.19967, 0.312666],
                [0.412113, 0.302224, 0.065617],
                [0.411995, 0.046952, 0.208659],
                [0.328071, 0.197764, 0.20287],
                [-0.207289, 0.32763, 0.328359],
                [0.577595, 0.44771, 0.458224],
                ...
                [0.162891, 0.547354, 0.31594],
                [0.079667, 0.699669, 0.312662],
                [0.412099, -0.197786, 0.065621],
                [0.411972, 0.54692, 0.208629],
                [0.328062, 0.697777, 0.20285],
                ...
                [0.66289, 0.547354, 0.315939],
                [0.579669, 0.699669, 0.312662],
                [-0.087899, -0.197786, 0.065621],
                [-0.088028, 0.54692, 0.208629],
                [-0.171939, 0.697777, 0.20285],
                ...
                [0.04277, 0.332385, 0.690326],
                [0.297194, 0.082675, -0.059486],
                [0.19668, 0.167416, 0.578049],
                [0.325052, 0.449677, 0.562626],
                [0.19291, 0.416904, 0.690611],
                [0.447789, 0.167818, -0.059972],
                [0.163105, 0.04811, -0.183851],
                [0.079925, 0.200025, -0.18688],
                [0.410091, 0.3001, 0.568463],
        ...
        cell = cellvectors(a=30.61955, b=30.70538, c=24.56766, A=90.0, B=90.0, C=90.0)
