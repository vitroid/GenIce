...
class UnitCell(genice3.unitcell.UnitCell):
    ...
    def __init__(self, **kwargs):
        ...
        cell = cellvectors(a=29.57133, b=29.57133, c=16.68224, A=90.0, B=90.0, C=90.0)
