    ...
    def __init__(self):
        ...
        waters = np.array(
            [
                ...
                [0.593512, 0.000156, -0.11129],
                [0.613213, 0.112538, 0.383597],
                [0.939825, -0.198423, 0.193457],
                [0.233226, 7.1e-05, 0.038928],
                [0.79392, 0.386971, 0.099873],
                [0.77941, -0.005963, -0.049479],
                [0.213169, -0.387527, -0.111004],
                [0.446734, 0.193706, -0.205426],
                [0.613573, 0.192327, 0.078395],
                [0.633656, -0.193502, -0.19496],
                [0.826965, 0.387251, -0.111187],
                [0.73226, -0.130545, 0.389678],
                [0.03955, 0.387773, 0.033362],
        ...
        cell = cellvectors(
            a=23.472, b=24.65765, c=26.95031, A=77.3042, B=63.4086, C=61.4293
        )
