...
No options available.
    ...
    def Hook7(self, ice):
        ...
        if len(atoms) > 99999:
            logger.warn(
                "  Gromacs fixed format cannot deal with atoms more than 99999. Residue number and atom number are faked.")
        s = ""
        ...
        if cellmat[1, 0] == 0 and cellmat[2, 0] == 0 and cellmat[2, 1] == 0:
            ...
            assert cellmat[0, 1] == 0 and cellmat[0,
                                                  2] == 0 and cellmat[1, 2] == 0
